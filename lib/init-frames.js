...
module.exports = async (opts) => {
  ...
  for (let i = 0; i < scenes.length; ++i) {
    ...
    // console.log(`idx: ${idx}, trimStart: ${scene.trimStart}, scene.transition.duration: ${scene.transition.duration}, trimEnd: ${scene.trimEnd}, trimDuration: ${scene.trimDuration}`)
